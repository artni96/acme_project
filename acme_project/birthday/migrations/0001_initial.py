# Generated by Django 3.2.16 on 2024-07-15 12:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='birthday',
            constraint=models.UniqueConstraint(fields=('first_name', 'last_name', 'birthday'), name='Уникальный запрос для пользователя'),
        ),
    ]
